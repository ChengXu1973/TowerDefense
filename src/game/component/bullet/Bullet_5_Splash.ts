module game {
    ...
    export class Bullet_5_Splash extends BaseBullet {
        ...
        public constructor() {
            ...
            this.shape.graphics.beginFill(0xEF1547, 1);
        ...
        */
        ...
        protected updateDisplay(): void {
            ...
            this.shape.alpha = Math.max((GlobalData.size * 1.5 - this.hitRange) / (GlobalData.size * 1.5), 0);
        ...
        protected checkNeedClear() {
            if (this.hitRange >= GlobalData.size * 1.5) {
                this.needClear = true;
            }
        }
    }
